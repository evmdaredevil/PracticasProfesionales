            ...
            foreach ($points as $pointData) {
                ...
                if ($coords) {
                    ...
                    $jsPoints[] = [
                        'lat' => $lat,
                        'lon' => $lon,
                        'popupContent' => "Nombre del Resonsable: " . $pointData['cnombreresponsable'] . " " . $pointData['csegundoapellidoresponsable'] . "<br>Email: " . $pointData['cemail'] . "<br>Fecha de Creación: " . $pointData['fechacreacion']
                    ];
                }
            }
