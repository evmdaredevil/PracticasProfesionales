...
<div id="overlay">
        <div id="disclaimer">
            <br>
            <img class="centered-image" src="rsc\cenapred.png" alt="CENAPRED Logo" width="15%" height="15%">
            <br>
            ...
            <br>
            <img class="centered-image" src="rsc/logo CERT.jpeg" alt="CERT Logo" width="35%" height="35%">
            <br>
